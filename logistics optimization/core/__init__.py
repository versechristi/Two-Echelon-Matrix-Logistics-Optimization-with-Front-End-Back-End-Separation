...
This allows other modules (e.g., fronted/main_window.py) to easily
...
try:
    from .problem_utils import (
        ...
        create_initial_solution, # MODIFIED: Corrected function name
        generate_neighbor_solution, # MODIFIED: Corrected function name
    ...
    def create_initial_solution(*args, **kwargs): print("ERROR: Dummy initial solution generator!"); return None
    def generate_neighbor_solution(*args, **kwargs): print("ERROR: Dummy neighbor generator!"); return None
...
__all__ = [
    ...
    'SolutionCandidate',
    'create_heuristic_trips_split_delivery',
    'create_initial_solution', # MODIFIED: Corrected exported name
    'generate_neighbor_solution', # MODIFIED: Corrected exported name
    'swap_mutation',
    'scramble_mutation',
    'inversion_mutation',
